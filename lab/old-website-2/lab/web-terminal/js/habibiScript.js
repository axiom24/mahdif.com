...
// if (textInputValueLowerCase.substr(textInputValueLowerCase.length - 4) == ".com"){ //if the last 4 characters = .com
//   alert('The last 4 characters are .com!'); // CONTINUE FROM HERE!
// }
